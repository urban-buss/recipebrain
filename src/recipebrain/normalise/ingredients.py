...
SEED_CATALOGUE: list[CanonicalIngredient] = [
    ...
    _ci(
        ...
        "pantry",
        "grain",
        aliases=["Weissmehl", "Weizenmehl", "Halbweissmehl", "Mehlmischung"],
        tags=["starchy", "baking"],
    ),
    _ci(
        84,
    ...
    _ci(
        ...
        "dried",
        unit="TL",
        aliases=["Kreuzkümmelpulver", "Kumin", "Cumin gemahlen"],
        tags=["spice", "earthy"],
    ),
    _ci(
        191,
    ...
    _ci(
        ...
        unit="EL",
        density=0.92,
        aliases=["Öl", "Frittieröl", "Pflanzenöl", "Speiseöl"],
        tags=["fat", "neutral"],
    ),
    _ci(
        509,
        ...
        unit="EL",
        density=0.92,
        aliases=["Schmalz", "Bratbutter"],
        tags=["fat", "animal"],
    ),
    # ------------------------------------------------------------------
    # High-frequency missing entries (issue #058)
    # ------------------------------------------------------------------
    ...
    _ci(
        ...
        "pantry",
        "grain",
        aliases=["Ruch-Mehl", "Halbweiss-Mehl"],
        tags=["starchy", "baking"],
    ),
    _ci(
        512,
        ...
        "pantry",
        "grain",
        aliases=["Dinkel-Mehl", "Dinkelvollkornmehl"],
        tags=["starchy", "baking"],
    ),
    _ci(
        513,
        ...
        "pantry",
        "grain",
        aliases=["Hartweizengriess", "Weizengriess", "Weizenriess"],
        tags=["starchy", "grain"],
    ),
    # -- Prepared doughs --
    _ci(
    ...
    _ci(
        ...
        "stock",
        unit="dl",
        aliases=["Kalbsbouillon", "Kalbsbrühe", "Kalbsjus"],
        tags=["umami", "veal"],
    ),
    _ci(
        516,
    ...
    _ci(
        ...
        "blend",
        unit="TL",
        aliases=["Lebkuchen-Gewürz"],
        tags=["spice", "sweet", "baking"],
    ),
    _ci(
        520,
        "five-spice",
        ...
        "blend",
        unit="TL",
        aliases=["5-Gewürze-Pulver", "Fünf-Gewürze-Pulver", "Five Spice"],
        tags=["spice", "asian"],
    ),
    _ci(
        521,
    ...
    _ci(
        ...
        "dried",
        unit="TL",
        aliases=["Koriander gemahlen", "gemahlener Koriander"],
        tags=["spice", "aromatic"],
    ),
    _ci(
        523,
        ...
        "dried",
        unit="TL",
        aliases=["Kümmelsamen", "Kümmelkörner"],
        tags=["spice", "earthy"],
    ),
    # -- Berries/fruit --
    _ci(
    ...
    _ci(
        ...
        "flavouring",
        unit="EL",
        aliases=["Holunderblüten-Sirup", "Holundersirup"],
        tags=["floral", "sweet"],
    ),
    _ci(
        527,
